...
# -------------------------------------------- 1번 그래프
ax.scatter(points[:, 0], points[:, 1], points[:, 2], label='transi points', color='g')
ax.scatter(transformed_data[:, 0], transformed_data[:, 1], transformed_data[:, 2], label='transformed points', color='b')
...
ax2.scatter(transformed_data[:, axis_idx], transformed_data[:, 2], label='yz points', color='cyan')     # 주축에 따라서 축 설정
